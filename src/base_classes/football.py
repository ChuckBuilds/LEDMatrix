...
class FootballLive(Football, SportsLive):
    ...
    def _draw_scorebug_layout(self, game: Dict, force_clear: bool = False) -> None:
        ...
        try:
            ...
            # Handle both PIL and freetype fonts for text measurement
            status_width = self._get_text_width(period_clock_text, self.fonts['time'])
            ...
            if scoring_event and game.get("is_live"):
                ...
                # Handle both PIL and freetype fonts for text measurement
                event_width = self._get_text_width(scoring_event, self.fonts['detail'])
                ...
                # Handle both PIL and freetype fonts for text measurement
                dd_width = self._get_text_width(down_distance, self.fonts['detail'])
